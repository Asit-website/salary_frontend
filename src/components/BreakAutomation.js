    ...
    return (
        <Layout style={{ minHeight: '100vh' }}>
            ...
            <Layout style={{ marginLeft: collapsed ? 80 : 200, background: '#f5f7fb', transition: 'all 0.2s' }}>
                <MainHeader collapsed={collapsed} setCollapsed={setCollapsed} title="Break Automation Rules" showHome={true} />
                ...
                <Content style={{ padding: '24px' }}>
                    ...
                    <div style={{ 
                        ...
                        <Space size="middle">
                            ...
                            <Breadcrumb style={{ margin: 0 }}>
                                ...
                                <Breadcrumb.Item>Break Automation Rules</Breadcrumb.Item>
                            </Breadcrumb>
                        </Space>
                        <Button 
                           type="primary" 
                    ...
                    >
                        <Form form={form} layout="vertical" onFinish={handleSave}>
                            ...
                            <Divider orientation="left"><span className="modal-field-label" style={{ fontSize: '15px' }}>Time Range Fines (Duration Based)</span></Divider>
                                            ...
                                            {fields.map(({ key, name, ...restField }, index) => (
                                                <div key={key} style={{ marginBottom: 24, borderBottom: index < fields.length - 1 ? '1px solid #eee' : 'none', paddingBottom: 16 }}>
                                                    <Row gutter={16} align="bottom">
                                                        <Col span={9}>
                                                            <span className="modal-field-label" style={{ display: 'block', marginBottom: 8 }}>If total break more than or equal to</span>
                                                            <Space>
                            ...
                            <Divider orientation="left"><span className="modal-field-label" style={{ fontSize: '15px' }}>Major Attendance Overrides</span></Divider>
                            ...
                            <div style={{ background: '#fafafa', padding: '16px', borderRadius: '12px', border: '1px solid #f0f2f5', marginBottom: '16px' }}>
                                <Form.Item name="deductHalfDay" valuePropName="checked" noStyle initialValue={false}>
                                    <Checkbox><span className="modal-field-label">Deduct half day salary if break more than or equal to</span></Checkbox>
                                </Form.Item>
                            ...
                            <div style={{ background: '#fafafa', padding: '16px', borderRadius: '12px', border: '1px solid #f0f2f5', marginBottom: '16px' }}>
                                <Form.Item name="deductFullDay" valuePropName="checked" noStyle initialValue={false}>
                                    <Checkbox><span className="modal-field-label">Deduct full day salary if break more than or equal to</span></Checkbox>
                                </Form.Item>
                                <div style={{ marginTop: 8, paddingLeft: 24 }}>
                                    <Space>
                    ...
                    >
                        <Space direction="vertical" style={{ width: '100%' }} size={16}>
                            <div>
                                <span className="modal-field-label" style={{ fontSize: '13px', display: 'block', marginBottom: '8px' }}>Select staff members to apply this break rule to:</span>
