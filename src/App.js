...
import EsiCalculationSettings from './components/EsiCalculationSettings';
...
function App() {
  return (
    <InactivityHandler>
      ...
      <Route path="/settings/esi-calculation" element={<PrivateRoute><EsiCalculationSettings /></PrivateRoute>} />
